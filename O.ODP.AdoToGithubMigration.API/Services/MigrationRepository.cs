...
public class MigrationRepository : IMigration
{
    private readonly IResourceSourceFactory _resourceSourceFactory;

    public MigrationRepository(IResourceSourceFactory resourceSourceFactory)
    {
    ...
    public MigrationResponse ProcessMigration()
    {
        ...
        {
            MigrationId = "1",
            MigrationType = ResourceTypeConstants.Repository,
